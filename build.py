...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','jp.msmc.tistoreproductview.js')
	...
	f = os.path.join(cwd,'Classes','JpMsmcTistoreproductviewModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.msmc.tistoreproductview.js']
